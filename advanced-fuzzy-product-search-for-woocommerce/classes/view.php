...
abstract class ViewAfsw extends BaseObjectAfsw {
	/*
	 * @deprecated
	 */
	protected $_tpl = AFSW_DEFAULT;
	/*
	...
	public function display( $tpl = '' ) {
		...
		if (false !== $content) {
			HtmlAfsw::echoEscapedHtml($content);
		}
	}
	public function getPath( $tpl ) {
		$path = '';
		$parentModule = FrameAfsw::_()->getModule( $this->_code );
	...
	public function getModel( $code = '' ) {
		return FrameAfsw::_()->getModule( $this->_code )->getController()->getModel($code);
	}
