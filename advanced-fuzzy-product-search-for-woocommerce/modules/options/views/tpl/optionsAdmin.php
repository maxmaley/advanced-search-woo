	...
	<form id="afswSettingsForm">
		<div class="woobewoo-item woobewoo-panel">
			...
			<div class="afsw-settings-section">
				...
				<?php $enabled = UtilsAfsw::getArrayValue($options, 'use_schedule_indexing', false); ?>
				<div class="afsw-settings-row">
					<div class="afsw-settings-label woobewoo-tooltip" title="<?php esc_attr_e('Indexing will start at the selected time according to the schedule.', 'advanced-fuzzy-search'); ?>">
					...
					<div class="afsw-settings-control">
						...
						?>
						<div class="afsw-schedule-options<?php echo $enabled ? '' : ' woobewoo-hidden'; ?>" data-parent="use_schedule_indexing">
							<span class="afsw-schedule-label"><?php esc_html_e('Day:', 'advanced-fuzzy-search'); ?></span>
							<?php
							...
							?>
							<span class="afsw-schedule-label"><?php esc_html_e('Hour:', 'advanced-fuzzy-search'); ?></span>
							<?php
			...
			<div class="afsw-settings-section">
				...
				<div class="afsw-settings-row woobewoo-nosave">
					<div class="afsw-settings-label">
						<?php esc_html_e('Clear history', 'advanced-fuzzy-search'); ?>
					</div>
					<div class="afsw-settings-control">
						<button class="button button-secondary" id="afswBtnHistory">
				...
				<?php $enabled_history = UtilsAfsw::getArrayValue($options, 'use_schedule_history', false); ?>
				<div class="afsw-settings-row">
					<div class="afsw-settings-label woobewoo-tooltip" title="<?php esc_attr_e('Clear history will start at the selected time according to the schedule.', 'advanced-fuzzy-search'); ?>">
						<?php esc_html_e('Clear on a schedule', 'advanced-fuzzy-search'); ?>
					</div>
					<div class="afsw-settings-control">
						<?php
						HtmlAfsw::checkboxToggle('use_schedule_history', array(
							'checked' => $enabled_history
						));
						?>
						<div class="afsw-schedule-options<?php echo $enabled_history ? '' : ' woobewoo-hidden'; ?>" data-parent="use_schedule_history">
							<span class="afsw-schedule-label"><?php esc_html_e('Day:', 'advanced-fuzzy-search'); ?></span>
							<?php
			...
			<div class="afsw-settings-section">
				...
				<div class="afsw-settings-row">
					<div class="afsw-settings-label woobewoo-tooltip" title="<?php esc_attr_e('Save debug messages to the WooCommerce SystemStatus Log.', 'advanced-fuzzy-search'); ?>">
